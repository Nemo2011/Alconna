from arclet.alconna.types import ObjectPattern, addCheck, ArgPattern, PatternToken
...
addCheck(ArgPattern("ariadne", PatternToken.REGEX_TRANSFORM, Ariadne, lambda x: bot, 'app'))
